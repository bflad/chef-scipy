...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :centos6 do |centos6|
    ...
    centos6.vm.hostname = 'scipy-centos-6'
  end
  ...
  config.vm.define :debian7 do |debian7|
    ...
    debian7.vm.hostname = 'scipy-debian-7'
  end
  ...
  config.vm.define :fedora18 do |fedora18|
    ...
    fedora18.vm.hostname = 'scipy-fedora-18'
  end
  ...
  config.vm.define :ubuntu1210 do |ubuntu1210|
    ...
    ubuntu1210.vm.hostname = 'scipy-ubuntu-1210'
  end
  ...
  config.vm.define :ubuntu1304 do |ubuntu1304|
    ...
    ubuntu1304.vm.hostname = 'scipy-ubuntu-1304'
  end
